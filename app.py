...
BROWSER_RESTART_AFTER_JOBS = int(os.environ.get("WENKU_BROWSER_RESTART_AFTER_JOBS", "10"))
JOB_STARTUP_ATTEMPT_TIMEOUT_SECONDS = float(os.environ.get("WENKU_JOB_STARTUP_ATTEMPT_TIMEOUT_SECONDS", "180"))
